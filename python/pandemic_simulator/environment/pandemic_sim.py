...
from .interfaces import ContactRate, ContactTracer, PandemicRegulation, PandemicSimState, PandemicTesting, \
    ...
    SimTime, SimTimeInterval, sorted_infection_summary, sorted_class_infection_summary, globals, PersonRoutineAssignment
...
class PandemicSim:
    ...
    def __init__(self,
        ...
        self._state = PandemicSimState(
            ...
            class_global_infection_summary={s: 0 for s in sorted_class_infection_summary},
    ...
    def step(self) -> None:
        ...
        if self._infection_update_interval.trigger_at_interval(self._state.sim_time):
            ...
            for person in self._id_to_person.values():
                ...
                if type(person) == Worker and person.state.infection_state.summary.name == 'INFECTED':
                    class_global_infection_summary[person.working_status] += 1
            ...
            self._state.class_global_infection_summary = class_global_infection_summary
